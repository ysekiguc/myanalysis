...
//---------------------------------------------------------------------------------------
class AliAnalysisTaskSEpPbCorrelationsForward : public AliAnalysisTaskSE {
public:
  AliAnalysisTaskSEpPbCorrelationsForward();
  AliAnalysisTaskSEpPbCorrelationsForward(const char *name);
  virtual ~AliAnalysisTaskSEpPbCorrelationsForward();
...
private:
  ...
  AliAnalysisTaskSEpPbCorrelationsForward &
  operator=(const AliAnalysisTaskSEpPbCorrelationsForward &det);
...
//---------------------------------------------------------------------------------------
Float_t AliAnalysisTaskSEpPbCorrelationsForward::GetDPhiStar(
