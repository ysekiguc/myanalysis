AliAnalysisTaskSEpPbCorrelationsForward* AddTaskpPbCorrelationsForward(
								       ...
								       TString anamode         ="FMDFMD_Ctrig",//TPCTPC, TPCV0A, TPCV0C, V0AV0C,TPCFMD, TPCFMDC, FMDFMD, SECA
								       TString anacent         ="SPDTracklets",//"SPDTracklets",
								       ...
								       )
{
  ...
  if (!mgr) {Error("AddTaskpPbCorrelationsForward.C", "No Analysis Manager");return 0;}
  ...
  */
  ...
  //Correlation task
  AliAnalysisTaskSEpPbCorrelationsForward *myTask = new AliAnalysisTaskSEpPbCorrelationsForward(fListName.Data());
